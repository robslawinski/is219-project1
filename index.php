...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="vendor/bootstrap/css/bootstrap.min.css"	type="text/css"/>
    <!-- Custom Fonts -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#services">Education</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#portfolio">Interests</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#about">Work Experience</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#team">Self</a>
                    </li>
                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Prospective graduation date - May 2018.</h3>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Here are my interests that are relevant to my interests.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        <h4>Fencing</h4>
                        <p class="text-muted">NJIT Men's Sabre Class of 2018</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">I have not provided any work experience, but I have wrote code for a few years.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">During my high school senior year, I was required to take a course in computer science. While it was difficult, I enjoyed the feeling of solving problems and writing code. When looking for college, I chose NJIT due to their financial aid offerings and state-of-the-art computer science program.</p>
                                </div>
                            </div>
                        </li>
                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li>Client: IS 219 - 002</li>
                                    <li>Category: Interests</li>
                                </ul>
